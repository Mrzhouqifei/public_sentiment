...
public class PreviewSketch extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener {
    ...
    protected void paintComponent(Graphics g) {
       ...
       System.out.println("preciewsketch:"+getWidth()+","+getHeight());
        System.out.println("target:"+target.getWidth()+","+target.getHeight());
...
//            MouseListenerTemplate mlt = new MouseListenerTemplate();
//            mlt.mouseClicked(e, previewController.getModel().getProperties(), previewController);
